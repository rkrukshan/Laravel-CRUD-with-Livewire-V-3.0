<div>
    ...
    <div class="alert alert-success"><h3 style="color: rgb(131, 129, 129)"><center>{{ session('alertmessage') }}
        ...
        @else(session()->has('alertmessagedelete'))
    <div class="alert alert-success"><h3 style="color: rgb(131, 129, 129)"><center>{{ session('alertmessagedelete') }}
        <hr>
        <h5 class="alert-heading">Your Information Successfully deleted in Our System</h5></center></h3></div>
    @endif
    @if($edit_mode)
