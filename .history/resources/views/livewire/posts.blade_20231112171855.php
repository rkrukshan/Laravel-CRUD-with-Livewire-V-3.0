...
@foreach($posts as $post)
   <tr>
    ...
    <td>{{ $post->title }}</td>
    <td>{{ $post->body }}</td>
    <td><button wire:click="edit({{ $p }})" type="button" class="btn btn-outline-info">Edit</button></td>
    <td><button wire:click="canceledit()" type="button" class="btn btn-outline-danger">Delete</button></td>
   </tr>
   @endforeach
</table>
