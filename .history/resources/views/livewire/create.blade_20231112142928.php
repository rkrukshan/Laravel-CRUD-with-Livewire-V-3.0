<form>
    ...
    <div class="form-group">
        ...
        <br>
        @error('title')
        <h5><span class="text-danger alert alert-danger d-flex align-items-center"> <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Danger:"><use xlink:href="#exclamation-triangle-fill"/></svg>{{ $message }}</span></h5>
        @enderror
        <br>
        <br>
    </div>
