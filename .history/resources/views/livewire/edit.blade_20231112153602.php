<form>
<div class="header"><center>Update Your Data</center></div>
    ...
    <br>
        <br>
    <center>
        <button wire:click.prevent="store()" type="submit" class="btn btn-success">Update</button>
        <button wire:click.prevent="update()" type="submit" class="btn btn-danger">Cancel</button>
    </center>
</form>
